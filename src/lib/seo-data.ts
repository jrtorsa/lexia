  ...
  const faqsMap: Record<string, Array<{ pregunta: string; respuesta: string }>> = {
    "derecho-familiar": [
      ...
      },
      {
        ...
        respuesta: `La pensión alimenticia en ${c.nombre} se determina considerando las necesidades del acreedor alimentario y las posibilidades reales del deudor. Los jueces familiares en ${c.nombre} suelen establecer pensiones entre el 20% y el 40% del ingreso del deudor para un hijo, incrementándose proporcionalmente con más beneficiarios. Si el deudor trabaja de manera informal, el abogado puede solicitar pruebas de ingresos o estimaciones basadas en su nivel de vida.`,
      },
      {
